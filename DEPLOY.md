...
> **文档状态：已归档，请勿阅读或参考其采集启动流程。**
> 本文记录旧 MongoDB 批处理部署方式，已不代表当前 Win11 多账号两阶段监听。当前安装与命令入口参考 `README.md`，采集执行逻辑只参考 `docs/WECHAT_SEARCH_COLLECTION_FLOW.md`。除非本文完成重写、移除此标记并同步测试，否则不得用于部署、实现或排障。
